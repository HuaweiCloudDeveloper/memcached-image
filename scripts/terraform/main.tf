...
module "ecs" {
  ...
  instance_image_id  = var.Version == "Memcached1.6.38-arm-v1.0" ? local.instance_image_id_maps_v1[data.huaweicloud_availability_zones.az.region] : local.instance_image_id_maps_v1[data.huaweicloud_availability_zones.az.region] 
